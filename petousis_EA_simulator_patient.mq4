...
input int i_stratMagicNumber = 25;    // Always positive
      ...
      for(int i=0; i<i_namesNumber; i++) {
         if (b_VWAP) {
            if (true) { // use constant vwap for sequence
               temp_T1 = iCustom(m_names[i,0],0,"petousis_VWAPsignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),i_mode,filter_supersmoother,false,f_deviationPerc,1000,m_sequence[i][0],3,1);
               m_VWAP[i] = iCustom(m_names[i,0],0,"petousis_VWAPsignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),i_mode,filter_supersmoother,false,f_deviationPerc,1000,m_sequence[i][0],2,1);       //needed at every tick
            }
            else {      // use varying vwap
               temp_T1 = iCustom(m_names[i,0],0,"petousis_VWAPsignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),i_mode,filter_supersmoother,false,f_deviationPerc,1000,-1,3,1);
               m_VWAP[i] = iCustom(m_names[i,0],0,"petousis_VWAPsignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),i_mode,filter_supersmoother,false,f_deviationPerc,1000,-1,2,1);       //needed at every tick
            }
         }
         else {
            temp_T1 = iCustom(m_names[i,0],0,"petousis_SuperSmootherSignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),filter_supersmoother,false,f_deviationPerc,1000,3,1);
            m_VWAP[i] = iCustom(m_names[i,0],0,"petousis_SuperSmootherSignal",StrToInteger(m_names[i,4]),StrToInteger(m_names[i,5]),filter_supersmoother,false,f_deviationPerc,1000,4,1);       //needed at every tick
         }
