...
double const f_minBollingerBandRatio = 0.25;    // [min upper band] = [central band] + parameter * 0.5*([average upper band] - [average lower band]), ie 1 means the minimum is the average.
